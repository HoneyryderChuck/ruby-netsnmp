...
This library supports and is tested against ruby versions 2.4 or more recent, including ruby 3. It also supports and tests against JRuby and Truffleruby.
